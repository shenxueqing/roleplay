...
public class versionTest {
	...
	public static void main(String args[]) {
		...
		//HttpPost post = new HttpPost("http://"+Config.ip+":"+Config.port+"/JustHoldOnServer-1.0.0/version");
		HttpPost post = new HttpPost("http://localhost:8080/roleplayServer-1.0.0/getRuleList");
