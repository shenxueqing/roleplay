...
public class GetUserHabitDetailTest {
	public static void main(String args[]) {
		HttpClient httpClient = new  DefaultHttpClient ();
		HttpPost post = new HttpPost("http://"+Config.ip+":"+Config.port+"/JustHoldOnServer-1.0.0/getUserHabitdetail");
		...
		params.add(new BasicNameValuePair("who",Config.ouqiuidtest));
