...
public class AddHabitTest {
	public static void main(String args[]) {
		...
		HttpPost post = new HttpPost("http://"+Config.ip+":"+Config.port+"/JustHoldOnServer-1.0.0/addHabit");
		...
		params.add(new BasicNameValuePair("habitid","265"));
		...
		params.add(new BasicNameValuePair("goal","我要加油"));
