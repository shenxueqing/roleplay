...
public class ModifyUserInfoTest  {
	public static void main(String args[]) {
		...
		HttpPost post = new HttpPost("http://"+Config.ip+":"+Config.port+"/JustHoldOnServer-1.0.0/modifyUserInfo");
		
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("uid",Config.ouqiuidtest));
		params.add(new BasicNameValuePair("username","momo"));
		params.add(new BasicNameValuePair("password",Config.ouqipwtest));
		params.add(new BasicNameValuePair("sex","m"));
		params.add(new BasicNameValuePair("description","路会越走越长，心会越走越静呀。"));
