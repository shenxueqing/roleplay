...
public class DoSearchUserTest {
	public static void main(String args[]) {
		HttpClient httpClient = new  DefaultHttpClient ();
		HttpPost post = new HttpPost("http://"+Config.ip+":"+Config.port+"/JustHoldOnServer-1.0.0/doSearchUser");
		  
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("uid",Config.uid));
		params.add(new BasicNameValuePair("password",Config.pw));
		params.add(new BasicNameValuePair("key","neno"));
