...
public class InviteFriendHabit2Test {
	/**
	 * @param args
	 */
	public static void main(String args[]) {
		HttpClient httpClient = new  DefaultHttpClient ();
		HttpPost post = new HttpPost("http://"+Config.ip+":"+Config.port+"/JustHoldOnServer-1.0.0/inviteFriendToHabit");
		
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("uid",Config.uid));
		params.add(new BasicNameValuePair("password",Config.pw));
		params.add(new BasicNameValuePair("frienduids","1762687133;3099594421"));
		params.add(new BasicNameValuePair("inviteps","啦啦啦"));
		params.add(new BasicNameValuePair("habitid","3"));
		


		params.add(new BasicNameValuePair("habitid","233"));
