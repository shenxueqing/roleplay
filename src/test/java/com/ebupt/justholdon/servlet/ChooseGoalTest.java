...
public class ChooseGoalTest {
	public static void main(String args[]) {
		HttpClient httpClient = new  DefaultHttpClient ();
		HttpPost post = new HttpPost("http://10.1.29.254:8012/JustHoldOnServer-1.0.0/chooseGoal");
		...
		params.add(new BasicNameValuePair("habitmaxnum","3"));
		params.add(new BasicNameValuePair("goalid","7"));
