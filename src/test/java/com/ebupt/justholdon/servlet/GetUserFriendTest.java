...
public class GetUserFriendTest {

	public static void main(String args[]) {
		HttpClient httpClient = new  DefaultHttpClient ();
		HttpPost post = new HttpPost("http://"+Config.ip+":"+Config.port+"/JustHoldOnServer-1.0.0/getUserFriends");
		
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("uid",Config.uid));
		params.add(new BasicNameValuePair("password",Config.pw));
		params.add(new BasicNameValuePair("maxnum","10000"));
	
		params.add(new BasicNameValuePair("startpos","0"));
		params.add(new BasicNameValuePair("who",Config.ouqiuid));
