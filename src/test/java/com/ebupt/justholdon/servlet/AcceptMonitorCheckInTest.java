...
public class AcceptMonitorCheckInTest {
	/**
	 * @param args
	 */
	public static void main(String args[]) {
		HttpClient httpClient = new  DefaultHttpClient ();
		HttpPost post = new HttpPost("http://"+Config.ip+":"+Config.port+"/" + Config.path + "acceptMonitorCheckIn");
        ...
        params.add(new BasicNameValuePair("checkinid","1"));
