...
public class InviteMonitorToHabitTest {
	/**
	 * @param args
	 */
	public static void main(String args[]) {
		HttpClient httpClient = new  DefaultHttpClient ();
		HttpPost post = new HttpPost("http://"+Config.ip+":"+Config.port+"/" + Config.path + "inviteMonitor");
		...
		params.add(new BasicNameValuePair("who","1818543793,2048702813,2821788670"));
        params.add(new BasicNameValuePair("punishments","lalalala"));
