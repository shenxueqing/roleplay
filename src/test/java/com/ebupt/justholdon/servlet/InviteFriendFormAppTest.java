...
public class InviteFriendFormAppTest {
	/**
	 * @param args
	 */
	public static void main(String args[]) {
		HttpClient httpClient = new  DefaultHttpClient ();
		HttpPost post = new HttpPost("http://"+Config.ip+":"+Config.port+"/JustHoldOnServer-1.0.0/inviteFromApp");
		...
		params.add(new BasicNameValuePair("invitenames","test2,ouqi"));
