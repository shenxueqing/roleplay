...
public class GetGoalLibTest {

	public static void main(String args[]) {
		HttpClient httpClient = new  DefaultHttpClient ();
		HttpPost post = new HttpPost("http://"+Config.ip+":"+Config.port+"/JustHoldOnServer-1.0.0/getGoalLib");
		...
		params.add(new BasicNameValuePair("maxnum","2"));
		params.add(new BasicNameValuePair("gettype","2"));
		params.add(new BasicNameValuePair("startpos","0"));
		//params.add(new BasicNameValuePair("typevalue","ALL"));
